...
In the future exploration of the data, we  hoped to gather daily breakdowns of revenue to see if the weather data would correlate then and possibly see if there is data on Track's volleyball league and its influence with other datasets. Through all these explorations we, as team, found this dataset sufficiently challenge and gathered all our skills from this course to venture and analyze a real world project. We would like to thank Michael Rebers in providing this oppurtunity for us and sharing his data for furthering our education.
## Dashboard
